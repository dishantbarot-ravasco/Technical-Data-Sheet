...
from .batch_views import (
    create_batch, get_batch, download_batch_zip, text_import_batch, print_all_batch,
)
...
urlpatterns = [
    ...
    # GET  /api/tds/batch/<id>/download-zip/      — download all PDFs as a ZIP archive (?copy=customer|internal)
